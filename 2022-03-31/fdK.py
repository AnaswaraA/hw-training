...
field =['product_url','bread_crumbs','product_name','description','brand','price','reviews','color','size','image_url']
pro =[]
...
def carbon(url):
    ...
    print(data)
    pro.append(data)
    with open('csv_data.csv','w',encoding = 'utf-8',newline='') as f:
